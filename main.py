...
def display_obstacle(height):
    pygame.draw.ellipse(SCREEN, OBSTACLE_COLOR, (obstacle_x, 0, OBSTACLE_WIDTH, height))
    bottom_obstacle_height = 635 - height - 150
    pygame.draw.ellipse(SCREEN, OBSTACLE_COLOR, (obstacle_x, 635, OBSTACLE_WIDTH, bottom_obstacle_height))
...
def start():
    ...
    display = startFont.render(f"PRESS SPACE BAR TO START", True, (235, 229, 52))
...
def game_over():
    ...
    display2 = game_over_font2.render(f"SCORE: {score} MAX SCORE: {maximum}", True, (235, 64, 52))
